      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-black font-bold text-6xl mb-6">A better way to track your job application.</h1>
        ...
        <ImageTabs/>
        {/* Features Section */}
        <section className="container mx-auto px-4 border-t bg-white py-24">
          {/* The Grid Box (No wrapper div needed around it anymore) */}
